...
#headers is a dictionary / JSON basically, python just calls it a dictionary
headers = {
...
#you can always go to the install location to find how to use some of these functions
